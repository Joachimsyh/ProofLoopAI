import type { ExtractedSignal } from '../data/demo';
import type { AudienceMatch, GtmPlaybookContent, ContentAssetResult, GrowthRecommendationResult } from '../data/demo';
import { DEMO_AUDIENCES, DEMO_GTM_PLAYBOOKS, DEMO_CONTENT_ASSETS, DEMO_GROWTH_RECOMMENDATIONS } from '../data/demo';
export { syncToZero } from './zero';
import { expandAudienceWithRag } from '../rag/pipeline';
import { isUnifyConfigured } from './unify';
