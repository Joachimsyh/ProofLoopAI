...
import type { CrmEntry, CrmSyncState } from '../store/memory';
import { buildZeroRecordPayload } from '../integrations/zero';
import type { ZeroSyncInput, ZeroSyncResult } from '../integrations/zero';
